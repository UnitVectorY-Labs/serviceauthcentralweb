<template>
    <div class="modal fade" id="authorizedAddScopeModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="authorizedAddScopeModalLabel" aria-hidden="true">
            ...
            <div v-show="!authorizedSuccess">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-check" v-for="(scope, index) in filteredAvailableScopes" :key="scope">
                        <input class="form-check-input" type="radio" :disabled="loading" :value="scope" v-model="selectedScope" :name="radioGroupName" :id="`scope-${index}`">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" :disabled="loading" @click="confirmAuthorize">Authorize</button>
                </div>
                </div>
            </div>
