<template>
  <div
    class="modal fade"
    id="clientCreateSecretModal"
    data-bs-backdrop="static"
    data-bs-keyboard="false"
    tabindex="-1"
    aria-labelledby="clientCreateSecretModalLabel"
    aria-hidden="true"
  >
        ...
        <div class="modal-body">
          ...
          <div v-else class="input-group mb-3">
            <div class="alert alert-danger" role="alert">
              ...
              <p>
                This is the only time you will be able to view or copy your client secret. Make sure to copy and
                securely store it now. If you lose this secret, there is no way to retrieve it again!
              </p>
            </div>
