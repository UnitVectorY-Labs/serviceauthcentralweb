    ...
    <div>
        ...
        <thead class="table-dark">
                <tr>
                    ...
                    <th scope="col">
                        <button type="button" class="btn btn-success float-end" data-bs-toggle="modal" @click="resetAddAvailableScope()" data-bs-target="#clientAddAvailableScopeModal" title="Add Available Scope">
